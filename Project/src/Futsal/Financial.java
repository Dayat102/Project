	...
	public Financial() {
		...
		btnTotal.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				TournamentCost tc = new TournamentCost();
				double a = tc.TourCost();
				double num1, num2, num3, num4, ans;
				try {
					num1 = Double.parseDouble(txtWeek1.getText());
					num2 = Double.parseDouble(txtWeek2.getText());
					num3 = Double.parseDouble(txtWeek3.getText());
					num4 = Double.parseDouble(txtWeek4.getText());
					
					opc = String.format("RM %.2f", a);
					ans = (num1 + num2 + num3 + num4) - a;
					txtCost.setText(opc);
					txtTotal.setText(Double.toString(ans));
					}catch(Exception e) {
