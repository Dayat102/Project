...
public class Login extends JFrame {
	...
	public Login() {
		...
		panel.setBounds(10, 20, 1031, 585);
		...
		lblNewLabel.setIcon(new ImageIcon("C:\\Users\\ASUS\\Downloads\\WhatsApp Image 2021-06-29 at 21.03.23.jpeg"));
		...
		btnMainMenu.setBorder(new LineBorder(new Color(0, 0, 0), 4));
		btnMainMenu.setBackground(new Color(128, 0, 128));
		btnMainMenu.setBounds(897, 403, 124, 51);
