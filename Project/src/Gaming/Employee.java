...
public class Employee extends JFrame {
	...
	public Employee() {
		...
		panel.setBorder(new MatteBorder(8, 8, 8, 8, (Color) new Color(204, 102, 204)));
		...
		panel_1.setBorder(new MatteBorder(8, 8, 8, 8, (Color) new Color(204, 153, 204)));
		...
		panel_1_1.setBorder(new MatteBorder(8, 8, 8, 8, (Color) new Color(204, 153, 204)));
		...
		cabPosition.setModel(new DefaultComboBoxModel(new String[] {"Make a Selection", "Manager", "Cleaner", "Cosultant", "Crew"}));
		...
		panel_1_2.setBorder(new MatteBorder(8, 8, 8, 8, (Color) new Color(204, 153, 204)));
		...
		btnExit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				frame = new JFrame();
				if (JOptionPane.showConfirmDialog(frame, "Confirm if you want to back", "Employee Registration System", 
		...
		panel_1_3.setBorder(new MatteBorder(8, 8, 8, 8, (Color) new Color(204, 153, 204)));
		...
		btnUpload.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
				File file = new File("C:\\\\Users\\\\ASUS\\\\eclipse-workspace\\\\Employee");
				if(!file.exists()) {
					file.createNewFile();
					}
		...
		btnUpload.setBounds(546, 376, 146, 38);
		panel.add(btnUpload);
